...
const fn = function (myObject) // Объявляем фун-ию, и задаем в ней возможность использования параметра в виде переменной "myObject"
{
...
// 4-й пример. Основан на использовании фун-ии "rtfm", из которой возвращается параметр в виде объекта.
...
// Вставка в качестве значения свойства объекта имени существующей в скрипте переменной - позволяет подставить в качестве значения свойства объекта - "соответсвующее значение присвоенное этой переменной в скрипте".
