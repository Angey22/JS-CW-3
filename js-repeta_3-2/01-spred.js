...
// В последнем примере мі увидели, что два массива не равні между собой. Однако два их первых элемента - равны. Это связано с тем, что при распылении сложных типов делается не копия, а ссылка на оригинальный сложный элемент.
